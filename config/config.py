...
MUST_JOIN = getenv("MUST_JOIN", "TodayExecution")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/erslry/musisi",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")

# GIT TOKEN ( if your edited repo is private)
GIT_TOKEN = getenv("GIT_TOKEN", "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")

# Only  Links formats are  accepted for this Var value.
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/ZeeYeonho")  # Example:- https://t.me/TheYukki
